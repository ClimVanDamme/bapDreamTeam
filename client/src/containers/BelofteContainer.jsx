...
const BelofteContainer = ({ soort, supportersliedStore }) => {
	...
	if (soort === 'afkick') {
		return <AfkickBelofte initiate={initiateCanvas} />;
	} else {
		return <VoornemenBelofte initiate={initiateCanvas} />;
	}
};
...
export default inject(`supportersliedStore`)(observer(BelofteContainer));
